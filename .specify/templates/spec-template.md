...
- **FR-006**: System MUST define reservation availability, state transitions,
...
- **Court**: One of the two managed reservable courts, with schedule and pricing relationships
- **Sport**: Supported sport for a reservation: wally, racket, or fútbol 2
